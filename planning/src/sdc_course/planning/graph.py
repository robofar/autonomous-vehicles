...
class Graph:
    ...
    def add_node(self, node_id: int):
        ...
        # Children nodes of this node will be added to this list
        self.nodes[node_id] = []
    ...
    def add_edge(
        ...
        :param cost: edge cost (distance I suppose?)
        :param path: path along the edge as List[carla.Waypoint] -> list of waypoints for this Edge (Edge can have multiple waypoints)
    ...
    def get_cost(self, from_node: int, to_node: int) -> int:
        """
        Returns the cost between from_node to to_node (i.e. the edge cost)
        """
        cost = 0.0
        #######################################################################
        ######################### TODO: IMPLEMENT THIS ########################
